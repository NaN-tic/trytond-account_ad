...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-account_ad',
    download_url='https://github.com:nantic/trytond-account_ad.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-account_ad.git'
    },
    classifiers=[
